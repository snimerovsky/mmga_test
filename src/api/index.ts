...
export class Api {
  ...
  public recoveryAsk = (params: any) => {
    return client.post(`/recovery/ask`, params);
  };

  public recoveryValidate = (params: any) => {
    return client.post(`/recovery/validate`, params);
  };

  public recoveryRecover = (params: any) => {
    return client.post(`/recovery/recover`, params);
  };
}
